...
fn check_has_elt<F: FnMut(&Value)>(es: &crate::ElasticSearchWrapper, mut fun: F) {
...
fn check_has_bob(es: &crate::ElasticSearchWrapper) {
...
pub fn rubber_zero_downtime_test(mut es: crate::ElasticSearchWrapper) {
...
pub fn rubber_custom_id(mut es: crate::ElasticSearchWrapper) {
...
pub fn rubber_ghost_index_cleanup(mut es: crate::ElasticSearchWrapper) {
...
fn get_munin_indexes(es: &crate::ElasticSearchWrapper) -> Vec<String> {
    use super::ToJson;
    let client = hyper::client::Client::new();
    let res = client
...
// return the list of the munin indexes
fn get_index_info(es: &crate::ElasticSearchWrapper, index: &str) -> Value {
    use super::ToJson;
    let client = hyper::client::Client::new();
    let res = client
...
pub fn rubber_empty_bulk(mut es: crate::ElasticSearchWrapper) {
